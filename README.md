# Cascaron · sala-edicion

Este repo **no tiene codigo**. Es una direccion vieja que sigue viva.

El tablero real vive en `yodesarrollomx/sala-edicion` y se sirve en:
...
`https://alexpueblag.github.io/sala-edicion/` daria 404 para siempre.
